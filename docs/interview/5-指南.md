...
### [#](http://interview.poetries.top/docs/guide.html#promise)Promise
...
### [#](http://interview.poetries.top/docs/guide.html#前端常遇见的数据结构问题)前端常遇见的数据结构问题
...
### [#](http://interview.poetries.top/docs/guide.html#算法的效率是通过算法复杂度来衡量的)算法的效率是通过算法复杂度来衡量的
...
### [#](http://interview.poetries.top/docs/guide.html#人人都要掌握的基础算法)人人都要掌握的基础算法
...
### [#](http://interview.poetries.top/docs/guide.html#快排和二分查找)快排和二分查找
...
### [#](http://interview.poetries.top/docs/guide.html#面试遇见不会的算法问题怎么办)面试遇见不会的算法问题怎么办
...
### [#](http://interview.poetries.top/docs/guide.html#正则匹配解题)正则匹配解题
...
### [#](http://interview.poetries.top/docs/guide.html#小结-3)小结
...
## [#](http://interview.poetries.top/docs/guide.html#六、一面-5-浏览器相关知识点与高频考题解析)六、一面 5：浏览器相关知识点与高频考题解析

> `Web` 前端工程师写的页面要跑在浏览器里面，所以面试中也会出现很多跟浏览器相关的面试题目。

### [#](http://interview.poetries.top/docs/guide.html#知识点梳理-5)知识点梳理
...
### [#](http://interview.poetries.top/docs/guide.html#加载页面和渲染过程)加载页面和渲染过程
...
### [#](http://interview.poetries.top/docs/guide.html#性能优化)性能优化
...
### [#](http://interview.poetries.top/docs/guide.html#详细解释)详细解释
...
### [#](http://interview.poetries.top/docs/guide.html#web-安全)Web 安全
...
## [#](http://interview.poetries.top/docs/guide.html#七、一面-6-开发环境相关知识点与高频考题解析)七、一面 6：开发环境相关知识点与高频考题解析

### [#](http://interview.poetries.top/docs/guide.html#知识点梳理-6)知识点梳理
...
### [#](http://interview.poetries.top/docs/guide.html#ide)IDE
...
### [#](http://interview.poetries.top/docs/guide.html#git)Git
...
### [#](http://interview.poetries.top/docs/guide.html#关于-svn)关于 SVN
...
### [#](http://interview.poetries.top/docs/guide.html#linux-基础命令)Linux 基础命令
...
### [#](http://interview.poetries.top/docs/guide.html#前端构建工具)前端构建工具
...
### [#](http://interview.poetries.top/docs/guide.html#调试方法)调试方法
...
### [#](http://interview.poetries.top/docs/guide.html#小结-4)小结

> 本小节总结了前端开发环境常考查的知识，这些知识也是前端程序员必须掌握的，否则会影响开发效率。

## [#](http://interview.poetries.top/docs/guide.html#八、二面-1-如何回答常见的软技能问题)八、二面 1：如何回答常见的软技能问题

> 面试是个技术活，不仅仅是技术，各种软技能的面试技巧也是非常重要的，尤其是程序员一般对于自己的软技能不是很看重，其实**软技能才是决定你职场能够走多远的关键**。

### [#](http://interview.poetries.top/docs/guide.html#程序员应该具备的软技能)程序员应该具备的软技能
...
### [#](http://interview.poetries.top/docs/guide.html#常见的软技能问题和提升)常见的软技能问题和提升
...
### [#](http://interview.poetries.top/docs/guide.html#小结-5)小结

本小节介绍了程序员除了业务技术能力之外应该日常修炼的软技能，在面试中，软技能会被以各种形式问起，候选人应该先了解有哪些软技能可以修炼，才能在回答软技能问题的时候，尽量提到自己具备的软技能。

## [#](http://interview.poetries.top/docs/guide.html#九、二面-2-如何介绍项目及应对项目细节追问)九、二面 2：如何介绍项目及应对项目细节追问
...
### [#](http://interview.poetries.top/docs/guide.html#怎样介绍自己做过的一个项目)怎样介绍自己做过的一个项目
...
### [#](http://interview.poetries.top/docs/guide.html#没有做过大型项目怎么办)没有做过大型项目怎么办
...
### [#](http://interview.poetries.top/docs/guide.html#项目细节和技术点的追问)项目细节和技术点的追问
...
### [#](http://interview.poetries.top/docs/guide.html#小结-6)小结

- 本小节介绍了面试中关于项目类问题的回答方法，介绍项目要使用四段体的方式，从背景、承担角色、收益效果和总结反思四个部分来介绍项目。
- 准备这个面试环节的时候，利用笔者一直提倡的「思维导图」法，好好回顾和梳理自己的项目。

## [#](http://interview.poetries.top/docs/guide.html#十、hr-面-谈钱不伤感情)十、HR 面：谈钱不伤感情
...
### [#](http://interview.poetries.top/docs/guide.html#匹配度考查)匹配度考查
...
### [#](http://interview.poetries.top/docs/guide.html#谈薪资)谈薪资
...
### [#](http://interview.poetries.top/docs/guide.html#准确定位和自我估值)准确定位和自我估值
...
### [#](http://interview.poetries.top/docs/guide.html#跟-hr-沟通的技巧)跟 HR 沟通的技巧
...
## [#](http://interview.poetries.top/docs/guide.html#十一、其他-面试注意事项)十一、其他：面试注意事项

> 除了前面小节中提到的一些面试中应该注意的问题，本小节再整理一些面试中应该注意的事项。

### [#](http://interview.poetries.top/docs/guide.html#注意社交礼仪)注意社交礼仪

虽然说 IT 行业不怎么注重工作环境，上下级也没有繁文缛节，但是在面试中还是应该注意一些社交礼仪的。像进门敲门、出门关门、站着迎人这类基本礼仪还是要做的。

### [#](http://interview.poetries.top/docs/guide.html#舒适但不随意的着装)舒适但不随意的着装

首先着装方面，不要太随意，也不要太正式，太正式的衣服可能会使人紧张，所以建议穿自己平时喜欢的衣服，关键是干净整洁。

### [#](http://interview.poetries.top/docs/guide.html#约个双方都舒服的面试时间)约个双方都舒服的面试时间
...
### [#](http://interview.poetries.top/docs/guide.html#面试后的提问环节)面试后的提问环节
...
### [#](http://interview.poetries.top/docs/guide.html#面试禁忌)面试禁忌
...
### [#](http://interview.poetries.top/docs/guide.html#最好自己带电脑)最好自己带电脑
...
### [#](http://interview.poetries.top/docs/guide.html#面试后的总结和思考)面试后的总结和思考
...
## [#](http://interview.poetries.top/docs/guide.html#十二、总结)十二、总结

### [#](http://interview.poetries.top/docs/guide.html#准备阶段)准备阶段
...
### [#](http://interview.poetries.top/docs/guide.html#技术面部分)技术面部分

> 集中梳理了 ECMAScript 基础、JS-Web-API、CSS 和 HTML、算法、浏览器和开发环境六大部分内容，并且就一些高频考题进行讲解。

### [#](http://interview.poetries.top/docs/guide.html#非技术面试部分)非技术面试部分
...
### [#](http://interview.poetries.top/docs/guide.html#hr-面)HR 面
...
### [#](http://interview.poetries.top/docs/guide.html#补充说明)补充说明
...
### [#](http://interview.poetries.top/docs/guide.html#node-js部分)Node.js部分
...
### [#](http://interview.poetries.top/docs/guide.html#前端框架-库)前端框架（库）
...
### [#](http://interview.poetries.top/docs/guide.html#移动开发)移动开发
